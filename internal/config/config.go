...
type Config struct {
	...
	// ISAPI credentials (for `sadp isapi` subcommands)
	HikvisionUsername string `env:"HIKVISION_USERNAME" envDefault:""`
	HikvisionPassword string `env:"HIKVISION_PASSWORD" envDefault:""`
